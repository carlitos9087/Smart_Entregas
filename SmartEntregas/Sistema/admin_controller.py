...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, id_admin):
        ...
        self.botao_configurar_conta.clicked.connect(lambda: self.precionar_botao_configurar_conta(self.id_admin))
        ...
        self.botao_cancelar_minha_conta.clicked.connect(self.precionar_botao_cancelar_conta)
    ...
    def precionar_botao_configurar_conta(self, id_admin):
    ...
    def precionar_botao_cancelar_conta(self):
        # deixa a lineEdit não editável
        self.lineEdit_nome_minha_conta.setReadOnly(True)
        self.lineEdit_email_minha_conta.setReadOnly(True)

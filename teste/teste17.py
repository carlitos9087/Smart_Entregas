...
class Mapa(QWidget):
    def __init__(self):
        ...
        self.remove_obstacle_button = QPushButton("Remover Obstáculos", self)
        right_layout.addWidget(self.remove_obstacle_button)
        self.remove_obstacle_button.clicked.connect(self.remover_obstaculos)  # Conectar a função de remover obstáculos

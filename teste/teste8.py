...
#############################
        ...
        frame1_layout.addStretch()  # Adiciona um espaço vazio
        ...
        self.center_button = QPushButton("OK")
        ...
        self.angle_label = QLabel(f"{self.carro.angulo}°")
    ...
    def update_car_position(self):
        ...
        self.image_label.setGeometry(int(self.carro.posicao[0]), int(self.carro.posicao[1]), 50, 50)

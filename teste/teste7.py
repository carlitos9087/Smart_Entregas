from PySide6.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QProgressBar, QLabel, QGridLayout, QFrame
...
class CarroWidget(QWidget):
    ...
    def init_ui(self):
        ...
        image_layout.addWidget(self.carro_label)

        # Adiciona o frame da imagem à esquerda
        main_layout.addWidget(image_frame, 0, 0)
        ...
        control_frame.setLayout(directional_layout)
        ...
        # Adiciona o frame de controle à direita
        main_layout.addWidget(control_frame, 0, 1)
